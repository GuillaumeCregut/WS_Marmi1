...
{
    $connection = createConnection();
    $query='INSERT INTO recipe(title,description) VALUES (:title,:desc)';
    $st=$connection->prepare($query);
    $st->bindValue(':title',$recipe['title'],PDO::PARAM_STR);
    $st->bindValue(':desc',$recipe['description'],PDO::PARAM_STR);
    $st->execute();
}